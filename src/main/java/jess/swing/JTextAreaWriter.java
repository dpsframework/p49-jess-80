...
/**
 * A simple Writer, suitable for constructing a PrintWriter, which
 * uses a JTextArea as its output. This class is a convenient way to
 * write a GUI in which Jess prints its output to a text
 * widget. Contents are kept to a maximum of 32000 characters,
 * assuming that no other code appends to this JTextArea.
 * <P>
 * (C) 2013 Sandia Corporation<br>
 * @see jess.awt.TextAreaWriter
 */
...
public class JTextAreaWriter extends Writer implements Serializable {
    ...
    private static final int MAXSIZE = 32000;
